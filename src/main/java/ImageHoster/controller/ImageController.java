...
public class ImageController {
	...
	// Comment service implemented to get the comments by image id
    ...
    // added validation only  owner of the image can edit the image.
	...
	// added validation only  owner of the image can Delete the image.
